		...
		<div class="row"> 
							<div class="col-md-12">
								<div class="about-logo">
									<h3>Contact Us Project Discription</h3>
									<p>Project management is the science and art of organizing all the components of a project. For example, the launching of a new service, a marketing campaign, or the development of a new product are projects. In fact, even a wedding is a project that requires management.</p>
                                    	<p>Specifically, the feeling-based project manager may be at risk for stress because of tendencies to: Focus too much on “being liked” by team members and stakeholders. Lose sight of the tasks of the project, focusing too much on the interpersonal status of the team</p>
								</div>  
							</div>
						</div>
	<div class="row">
								<div class="col-md-6">
									<p>Unity is the most significant feature and the most important factor of human's life</p>
