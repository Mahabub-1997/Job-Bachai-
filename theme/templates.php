  ...
  <header>
        <div class="topbar navbar-fixed-top">
          <div class="container">
            <div class="row">
              <div class="col-md-12">      
                <p class="pull-left hidden-xs"><i class="fa fa-phone"></i>Tel No: 01768198718</p>
        ...
        <div class="navbar navbar-default navbar-static-top" > 
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo web_root; ?>index.php">BD Job Hire<!-- <img src="<?php echo web_root; ?>plugins/home-plugins/img/logo.png" alt="logo"/> --></a>
                </div>
    ...
    <div class="row">
      <div class="col-md-4 col-sm-4">
        <div class="widget">
          ...
          Cresent Road, Green Road<br>
           Dhanmondi,Dhaka-1205 </address>
          <p>
            <i class="icon-phone"></i> (+088) 01768198718 <br>
            <i class="icon-envelope-alt"></i> Mahabubul.islam@NorthSouth.edu
          </p>
        </div>
      </div>
      <div class="col-md-4 col-sm-4">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6">
          <div class="copyright">
            <p>
              <span>&copy; Lizu 2019 All right reserved.  
            </p>
          </div>
        </div>
        <div class="col-lg-6">
